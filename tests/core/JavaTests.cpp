...
static const std::string TEST_ECHO_BASE64_JDK16_CLASS = "echo";
static const std::string TEST_ECHO_BASE64_JDK16_CODE = "";
static size_t TEST_ECHO_HEX_JDK16_CODE_LEN = 273;
static byte TEST_ECHO_HEX_JDK16_CODE[] = {
  0xca, 0xfe, 0xba, 0xbe, 0x00, 0x00, 0x00, 0x32, 0x00, 0x0f, 0x0a, 0x00, 0x03, 0x00, 0x0c, 0x07,
  0x00, 0x0d, 0x07, 0x00, 0x0e, 0x01, 0x00, 0x06, 0x3c, 0x69, 0x6e, 0x69, 0x74, 0x3e, 0x01, 0x00,
  0x03, 0x28, 0x29, 0x56, 0x01, 0x00, 0x04, 0x43, 0x6f, 0x64, 0x65, 0x01, 0x00, 0x0f, 0x4c, 0x69,
  0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x01, 0x00, 0x03,
  0x72, 0x75, 0x6e, 0x01, 0x00, 0x26, 0x28, 0x4c, 0x6a, 0x61, 0x76, 0x61, 0x2f, 0x6c, 0x61, 0x6e,
...
BOOST_AUTO_TEST_CASE(JavaEngineClassLoaderBase64Test) {
  ...
  /* TODO Generated byte codes using JDK 1.7 are not run MacOSX
  ...
  */
  ...
  // TODO Generated byte codes using JDK 1.7 are OK MacOSX, but can not redefine class.
  classNames.push_back(TEST_ECHO_BASE64_JDK16_CLASS);
  classCodes.push_back((byte *)TEST_ECHO_BASE64_JDK16_CODE.c_str());
  classCodeLengths.push_back(TEST_ECHO_BASE64_JDK16_CODE.length());
  classCodeEncords.push_back(Script::ENCODING_BASE64);

  classNames.push_back(TEST_ECHO_BASE64_JDK16_CLASS);
  classCodes.push_back(TEST_ECHO_HEX_JDK16_CODE);
